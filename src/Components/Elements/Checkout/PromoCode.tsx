...
export default function PromoCode() {
  ...
  return (
    <section className="overflow-hidden rounded-3xl bg-white shadow-[0px_1px_13px_0px] shadow-emerald-300/30 dark:bg-neutral-900">
      {/* Header */}
      ...
      <div className="space-y-5 p-6">
        <div className="flex flex-col gap-3">
          <input
            ...
            className="h-12 rounded-lg border border-neutral-300 bg-white px-4 text-neutral-900 outline-none transition-all placeholder:text-neutral-400 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 dark:border-neutral-700 dark:bg-neutral-800 dark:text-white dark:focus:ring-emerald-500/20"
          />
        ...
        {discount === 0 ? (
              ...
              <div className="flex flex-wrap gap-2">
                {coupons.map((coupon) => (
                  <button
                    ...
                    className="rounded-full border border-emerald-200 bg-emerald-50 px-4 py-2 text-sm font-medium text-emerald-700 transition-all hover:border-emerald-300 hover:bg-emerald-100 active:scale-95 dark:border-emerald-500/30 dark:bg-emerald-500/10 dark:text-emerald-400 dark:hover:border-emerald-400 dark:hover:bg-emerald-500/20"
                  >
                    {coupon}
                  </button>
                ))}
          ...
          <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4 dark:border-emerald-500/30 dark:bg-emerald-500/10">
            ...
            <button
              ...
              className="mt-4 text-sm font-semibold text-red-500 transition hover:text-red-600 dark:hover:text-red-400"
            >
              Remove Coupon
            </button>
          </div>
