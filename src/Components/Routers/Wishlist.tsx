...
export default function Wishlist() {
  ...
  const wishlistProducts = shuffledProducts.filter((product) => userWishlist.includes(String(product.id)));
        ...
        <div className="flex items-center justify-between">
          ...
          {wishlistProducts.length > 0 && (
            <button
              ...
              className="self-start rounded-md border-2 border-black bg-transparent px-12 py-4 text-black transition-all duration-300 hover:border-[#DB4444] hover:bg-[#DB4444] hover:text-white sm:self-auto"
            >
              Move All To Bag
            </button>
          )}
